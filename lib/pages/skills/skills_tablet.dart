...
class SkillsTablet extends StatefulWidget {

  const SkillsTablet({super.key});

  @override
  State<SkillsTablet> createState() => _SkillsState();
}

class _SkillsState extends State<SkillsTablet> {
          ...
          children: [
            Row(
              children: [
                ...
                Text(AppStrings.skills,style: AppTheme.textStyle(AppDimensions.largeFont, FontWeight.w500, Colors.black),),
              ],
            ),
            const SizedBox(height: 10,),
            Text(AppStrings.skillDesc,style: AppTheme.textStyle(AppDimensions.mediumFont, FontWeight.w400, Colors.black),),
